...
INSERT INTO activity_log ("timestamp",activity) VALUES
	 (1711756957744514048,0),
	 (1711756957744514050,0),
	 (1711753357744514048,1),
	 (1711756957744514048,1),
	 (1711756957744514048,2),
	 (1711760557744514048,2),
	 (1711760557744514048,0);
